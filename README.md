...
For selection checklist template:  [Model Selection Checklist & Evaluation Template](https://github.com/VoxSecuritatis/Hugging_Face-Best_Model_Selection/blob/main/model_selection_template.md)
